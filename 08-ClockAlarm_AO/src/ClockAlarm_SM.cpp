...
static QState Clock_Alarm_Hour_D2(Clock_Alarm * const me);
static QState Clock_Alarm_Min_D1(Clock_Alarm * const me);
static QState Clock_Alarm_Min_D2(Clock_Alarm * const me);
static QState Clock_Alarm_Sec_D1(Clock_Alarm * const me);
static QState Clock_Alarm_Sec_D2(Clock_Alarm * const me);
static QState Clock_Alarm_Hour_D1(Clock_Alarm * const me);
static QState Clock_Alarm_Format(Clock_Alarm * const me);
static QState Clock_Alarm_Error(Clock_Alarm * const me);
...
/*.${AOs::Clock_Alarm::GetCurrentTime} .....................................*/
static uint32_t Clock_Alarm_GetCurrentTime(void) {
    uint32_t temp = 0u;
    noInterrupts();
...
/*.${AOs::Clock_Alarm::UpdateCurrentTime} ..................................*/
static void Clock_Alarm_UpdateCurrentTime(void) {
...
/*.${AOs::Clock_Alarm::SetCurrentTime} .....................................*/
static void Clock_Alarm_SetCurrentTime(uint32_t new_current_time) {
 ...
 * param3: column number of the LCD
 */
/*.${AOs::Clock_Alarm::DisplayCurrentTime} .................................*/
static void Clock_Alarm_DisplayCurrentTime(Clock_Alarm * const me, uint8_t row, uint8_t col) {
...
/*.${AOs::Clock_Alarm::DisplayClockSettingTime} ............................*/
static void Clock_Alarm_DisplayClockSettingTime(Clock_Alarm * const me, uint8_t row, uint8_t col) {
    String time_as_string;
...
static QState Clock_Alarm_Ticking(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case SET_SIG: {
            /* Set Signal is Received this means it is a clock setting */
        ...
        case OK_SIG: {
            /* OK Signal is Received this means it is a Alarm setting */
...
static QState Clock_Alarm_Settings(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case OK_SIG: {
            /* take action based on the current setting */
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D2} .......................*/
static QState Clock_Alarm_Hour_D2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D2} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D2::SET} */
        case SET_SIG: {
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D2::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Min_D1);
            break;
        }
        default: {
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D1} ........................*/
static QState Clock_Alarm_Min_D1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D1} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D1::SET} */
        case SET_SIG: {
            /* increment the temp digit */
            me->temp_digit++;
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D1::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Min_D2);
            break;
        }
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Settings);
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D2} ........................*/
static QState Clock_Alarm_Min_D2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D2} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D2::SET} */
        case SET_SIG: {
            /* increment the temp digit */
            me->temp_digit++;
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Min_D2::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Sec_D1);
            break;
        }
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Settings);
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D1} ........................*/
static QState Clock_Alarm_Sec_D1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D1} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D1::SET} */
        case SET_SIG: {
            /* increment the temp digit */
            me->temp_digit++;
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D1::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Sec_D2);
            break;
        }
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Settings);
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D2} ........................*/
static QState Clock_Alarm_Sec_D2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D2} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D2::SET} */
        case SET_SIG: {
            /* increment the temp digit */
            me->temp_digit++;
            /* Digit-1 value of minute digit can vary between 0, 1...9 */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Sec_D2::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Format);
            break;
        }
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Settings);
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D1} .......................*/
static QState Clock_Alarm_Hour_D1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D1} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D1::SET} */
        case SET_SIG: {
            /* increment the temp digit */
            me->temp_digit++;
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Hour_D1::OK} */
        case OK_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Hour_D2);
            break;
        }
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Settings);
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Format} ........................*/
static QState Clock_Alarm_Format(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Format} */
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Format::SET} */
        case SET_SIG: {
            String msg;
            if( me->temp_format == FORMAT_24H )
            {
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Format::OK} */
        case OK_SIG: {
            /*.${AOs::Clock_Alarm::SM::Clock::Settings::Format::OK::[TimeIsCorrect?]} */
            if (IsTime_NotCorrect( me->temp_time, (time_format_t)me->temp_format )) {
                status_ = Q_TRAN(&Clock_Alarm_Error);
            }
            /*.${AOs::Clock_Alarm::SM::Clock::Settings::Format::OK::[else]} */
            else {
                /*.${AOs::Clock_Alarm::SM::Clock::Settings::Format::OK::[else]::[AlaramSetting?]} */
                if (me->current_setting == ALARM_SETTING) {
...
static QState Clock_Alarm_Error(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Error::initial} */
        case Q_INIT_SIG: {
...
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Error::Error_On} ...............*/
static QState Clock_Alarm_Error_On(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Error::Error_On} */
        ...
        default: {
            status_ = Q_SUPER(&Clock_Alarm_Error);
            break;
        }
    }
    return status_;
}
/*.${AOs::Clock_Alarm::SM::Clock::Settings::Error::Error_Off} ..............*/
static QState Clock_Alarm_Error_Off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Clock::Settings::Error::Error_Off} */
...
static QState Clock_Alarm_Notify(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${AOs::Clock_Alarm::SM::Notify::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_Notify_Msg_On);
            break;
        }
        /*.${AOs::Clock_Alarm::SM::Notify::OK} */
        case OK_SIG: {
...
/*.${AOs::Clock_Alarm::SM::Notify::Notify_Msg_On} ..........................*/
static QState Clock_Alarm_Notify_Msg_On(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Notify::Notify_Msg_On} */
...
/*.${AOs::Clock_Alarm::SM::Notify::Notify_Msg_Off} .........................*/
static QState Clock_Alarm_Notify_Msg_Off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${AOs::Clock_Alarm::SM::Notify::Notify_Msg_Off} */
